const Presence = ({
	...
	return (
		...
		">
			<Header actType={actType} appName={appName}/>
			<Body
	...
	return (
		<div className="w-full flex flex-col gap-1">
			<ActivityInfo actType={actType} appName={appName}
				state={state} details={details}
			/>
			{["listening", "watching"].includes(actType) ? (
				<Progressbar ts_start={ts_start} ts_end={ts_end}/>
			) : (
				<Timer ts_start={ts_start}/>
			)}
		</div>
	)
}
...
const ActivityInfo = ({
	...
	return (
		<div className="flex flex-col">
			{["listening", "watching"].includes(actType) ? null : (
